# Random Forest Model
# Ensemble model that builds multiple decision trees on random subsets
# of the data and averages their predictions.
...
# Trains a Random Forest Regressor, evaluates it, and saves predictions.
...
def train_and_evaluate(include_expected: bool = True):
    ...
    # max_depth=20: allows complex splits without overfitting
